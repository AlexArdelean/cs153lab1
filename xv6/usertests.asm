...
opentest(void)
{
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  printf(stdout, "open test ok\n");
      94:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     13e:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     17f:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  i = read(fd, buf, 2000);
     ...
     207:	00 
     208:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     20f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     3c6:	00 
     3c7:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     3ce:	00 
    ...
    if(i == 0){
     ...
     3ec:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     3f1:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f4:	89 54 24 08          	mov    %edx,0x8(%esp)
     3f8:	c7 44 24 04 95 43 00 	movl   $0x4395,0x4(%esp)
     3ff:	00 
     400:	89 04 24             	mov    %eax,(%esp)
     403:	e8 b1 39 00 00       	call   3db9 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     419:	c7 04 24 40 43 00 00 	movl   $0x4340,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     49a:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     49f:	c7 44 24 04 e4 43 00 	movl   $0x43e4,0x4(%esp)
     4a6:	00 
     4a7:	89 04 24             	mov    %eax,(%esp)
     4aa:	e8 0a 39 00 00       	call   3db9 <printf>
    exit();
     4af:	e8 64 37 00 00       	call   3c18 <exit>
  }
  printf(stdout, "big files ok\n");
     4b4:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     4b9:	c7 44 24 04 f7 43 00 	movl   $0x43f7,0x4(%esp)
     4c0:	00 
     4c1:	89 04 24             	mov    %eax,(%esp)
     4c4:	e8 f0 38 00 00       	call   3db9 <printf>
}
     4c9:	c9                   	leave  
     4ca:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4d1:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     4d6:	c7 44 24 04 08 44 00 	movl   $0x4408,0x4(%esp)
     4dd:	00 
     4de:	89 04 24             	mov    %eax,(%esp)
     4e1:	e8 d3 38 00 00       	call   3db9 <printf>

  name[0] = 'a';
     4e6:	c6 05 60 a6 00 00 61 	movb   $0x61,0xa660
  name[2] = '\0';
     4ed:	c6 05 62 a6 00 00 00 	movb   $0x0,0xa662
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     503:	a2 61 a6 00 00       	mov    %al,0xa661
    fd = open(name, O_CREATE|O_RDWR);
     508:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     50f:	00 
     510:	c7 04 24 60 a6 00 00 	movl   $0xa660,(%esp)
  ...
  name[0] = 'a';
     534:	c6 05 60 a6 00 00 61 	movb   $0x61,0xa660
  name[2] = '\0';
     53b:	c6 05 62 a6 00 00 00 	movb   $0x0,0xa662
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     551:	a2 61 a6 00 00       	mov    %al,0xa661
    unlink(name);
     556:	c7 04 24 60 a6 00 00 	movl   $0xa660,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56c:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     571:	c7 44 24 04 30 44 00 	movl   $0x4430,0x4(%esp)
     578:	00 
     579:	89 04 24             	mov    %eax,(%esp)
     57c:	e8 38 38 00 00       	call   3db9 <printf>
}
     581:	c9                   	leave  
     582:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     589:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     58e:	c7 44 24 04 56 44 00 	movl   $0x4456,0x4(%esp)
     595:	00 
     596:	89 04 24             	mov    %eax,(%esp)
     599:	e8 1b 38 00 00       	call   3db9 <printf>

  if(mkdir("dir0") < 0){
     59e:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     5a5:	e8 d6 36 00 00       	call   3c80 <mkdir>
     5aa:	85 c0                	test   %eax,%eax
     5ac:	79 1a                	jns    5c8 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ae:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     5b3:	c7 44 24 04 67 44 00 	movl   $0x4467,0x4(%esp)
     5ba:	00 
     5bb:	89 04 24             	mov    %eax,(%esp)
     5be:	e8 f6 37 00 00       	call   3db9 <printf>
    exit();
     5c3:	e8 50 36 00 00       	call   3c18 <exit>
  }

  if(chdir("dir0") < 0){
     5c8:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     5cf:	e8 b4 36 00 00       	call   3c88 <chdir>
     5d4:	85 c0                	test   %eax,%eax
     5d6:	79 1a                	jns    5f2 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d8:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     5dd:	c7 44 24 04 75 44 00 	movl   $0x4475,0x4(%esp)
     5e4:	00 
     5e5:	89 04 24             	mov    %eax,(%esp)
     5e8:	e8 cc 37 00 00       	call   3db9 <printf>
    exit();
     5ed:	e8 26 36 00 00       	call   3c18 <exit>
  }

  if(chdir("..") < 0){
     5f2:	c7 04 24 88 44 00 00 	movl   $0x4488,(%esp)
     5f9:	e8 8a 36 00 00       	call   3c88 <chdir>
     5fe:	85 c0                	test   %eax,%eax
     600:	79 1a                	jns    61c <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     602:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     607:	c7 44 24 04 8b 44 00 	movl   $0x448b,0x4(%esp)
     60e:	00 
     60f:	89 04 24             	mov    %eax,(%esp)
     612:	e8 a2 37 00 00       	call   3db9 <printf>
    exit();
     617:	e8 fc 35 00 00       	call   3c18 <exit>
  }

  if(unlink("dir0") < 0){
     61c:	c7 04 24 62 44 00 00 	movl   $0x4462,(%esp)
     623:	e8 40 36 00 00       	call   3c68 <unlink>
     628:	85 c0                	test   %eax,%eax
     62a:	79 1a                	jns    646 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62c:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     631:	c7 44 24 04 9c 44 00 	movl   $0x449c,0x4(%esp)
     638:	00 
     639:	89 04 24             	mov    %eax,(%esp)
     63c:	e8 78 37 00 00       	call   3db9 <printf>
    exit();
     641:	e8 d2 35 00 00       	call   3c18 <exit>
  }
  printf(stdout, "mkdir test\n");
     646:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     64b:	c7 44 24 04 56 44 00 	movl   $0x4456,0x4(%esp)
     652:	00 
     653:	89 04 24             	mov    %eax,(%esp)
     656:	e8 5e 37 00 00       	call   3db9 <printf>
}
     65b:	c9                   	leave  
     65c:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     663:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     668:	c7 44 24 04 b0 44 00 	movl   $0x44b0,0x4(%esp)
     66f:	00 
     670:	89 04 24             	mov    %eax,(%esp)
     673:	e8 41 37 00 00       	call   3db9 <printf>
  if(exec("echo", echoargv) < 0){
     678:	c7 44 24 04 68 5e 00 	movl   $0x5e68,0x4(%esp)
     67f:	00 
     680:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
     687:	e8 c4 35 00 00       	call   3c50 <exec>
     68c:	85 c0                	test   %eax,%eax
     68e:	79 1a                	jns    6aa <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     690:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
     695:	c7 44 24 04 bb 44 00 	movl   $0x44bb,0x4(%esp)
     69c:	00 
     69d:	89 04 24             	mov    %eax,(%esp)
     6a0:	e8 14 37 00 00       	call   3db9 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6c1:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
     6c8:	00 
     6c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6d0:	e8 e4 36 00 00       	call   3db9 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     71c:	81 c2 60 86 00 00    	add    $0x8660,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     73b:	00 
     73c:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     743:	00 
     ...
     753:	c7 44 24 04 dc 44 00 	movl   $0x44dc,0x4(%esp)
     75a:	00 
     75b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     762:	e8 52 36 00 00       	call   3db9 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7ac:	05 60 86 00 00       	add    $0x8660,%eax
     ...
     7c9:	c7 44 24 04 ea 44 00 	movl   $0x44ea,0x4(%esp)
     7d0:	00 
     7d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d8:	e8 dc 35 00 00       	call   3db9 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     812:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     819:	00 
    ...
    if(total != 5 * 1033){
     ...
     83f:	c7 44 24 04 f8 44 00 	movl   $0x44f8,0x4(%esp)
     846:	00 
     847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84e:	e8 66 35 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     868:	c7 44 24 04 1e 45 00 	movl   $0x451e,0x4(%esp)
     86f:	00 
     870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     877:	e8 3d 35 00 00       	call   3db9 <printf>
    ...
    printf(1, "fork() failed\n");
     87e:	c7 44 24 04 0f 45 00 	movl   $0x450f,0x4(%esp)
     885:	00 
     886:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88d:	e8 27 35 00 00       	call   3db9 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89f:	c7 44 24 04 28 45 00 	movl   $0x4528,0x4(%esp)
     8a6:	00 
     8a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ae:	e8 06 35 00 00       	call   3db9 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     901:	00 
     902:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
     909:	00 
     ...
     917:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
     91e:	00 
     91f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     926:	e8 8e 34 00 00       	call   3db9 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     94d:	00 
     94e:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     955:	00 
    ...
    printf(1, "preempt read error");
     963:	c7 44 24 04 48 45 00 	movl   $0x4548,0x4(%esp)
     96a:	00 
     96b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     972:	e8 42 34 00 00       	call   3db9 <printf>
  ...
  printf(1, "kill... ");
     984:	c7 44 24 04 5b 45 00 	movl   $0x455b,0x4(%esp)
     98b:	00 
     98c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     993:	e8 21 34 00 00       	call   3db9 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b9:	c7 44 24 04 64 45 00 	movl   $0x4564,0x4(%esp)
     9c0:	00 
     9c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c8:	e8 ec 33 00 00       	call   3db9 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9dc:	c7 44 24 04 6d 45 00 	movl   $0x456d,0x4(%esp)
     9e3:	00 
     9e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9eb:	e8 c9 33 00 00       	call   3db9 <printf>
}
     9f0:	c9                   	leave  
     9f1:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0d:	79 16                	jns    a25 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0f:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     a16:	00 
     a17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1e:	e8 96 33 00 00       	call   3db9 <printf>
      return;
    ...
    if(pid){
     ...
     a35:	c7 44 24 04 86 45 00 	movl   $0x4586,0x4(%esp)
     a3c:	00 
     a3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a44:	e8 70 33 00 00       	call   3db9 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a5a:	c7 44 24 04 96 45 00 	movl   $0x4596,0x4(%esp)
     a61:	00 
     a62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a69:	e8 4b 33 00 00       	call   3db9 <printf>
}
     a6e:	c9                   	leave  
     a6f:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a76:	c7 44 24 04 a3 45 00 	movl   $0x45a3,0x4(%esp)
     a7d:	00 
     a7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a85:	e8 2f 33 00 00       	call   3db9 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac2:	e8 e2 35 00 00       	call   40a9 <malloc>
    ...
    while(m1){
     ...
     ae0:	e8 8b 34 00 00       	call   3f70 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b30:	e8 3b 34 00 00       	call   3f70 <free>
    printf(1, "mem ok\n");
     b35:	c7 44 24 04 c7 45 00 	movl   $0x45c7,0x4(%esp)
     b3c:	00 
     b3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b44:	e8 70 32 00 00       	call   3db9 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5b:	c7 44 24 04 cf 45 00 	movl   $0x45cf,0x4(%esp)
     b62:	00 
     b63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b6a:	e8 4a 32 00 00       	call   3db9 <printf>

  unlink("sharedfd");
     b6f:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
     b76:	e8 ed 30 00 00       	call   3c68 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b82:	00 
     b83:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b98:	c7 44 24 04 e8 45 00 	movl   $0x45e8,0x4(%esp)
     b9f:	00 
     ba0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba7:	e8 0d 32 00 00       	call   3db9 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c0a:	c7 44 24 04 14 46 00 	movl   $0x4614,0x4(%esp)
     c11:	00 
     c12:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c19:	e8 9b 31 00 00       	call   3db9 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4f:	00 
     c50:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c65:	c7 44 24 04 34 46 00 	movl   $0x4634,0x4(%esp)
     c6c:	00 
     c6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c74:	e8 40 31 00 00       	call   3db9 <printf>
    return;
  ...
  unlink("sharedfd");
     cf6:	c7 04 24 de 45 00 00 	movl   $0x45de,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d14:	c7 44 24 04 5f 46 00 	movl   $0x465f,0x4(%esp)
     d1b:	00 
     d1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d23:	e8 91 30 00 00       	call   3db9 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d38:	c7 44 24 04 6c 46 00 	movl   $0x466c,0x4(%esp)
     d3f:	00 
     d40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d47:	e8 6d 30 00 00       	call   3db9 <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d59:	c7 44 24 04 81 46 00 	movl   $0x4681,0x4(%esp)
     d60:	00 
     d61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d68:	e8 4c 30 00 00       	call   3db9 <printf>

  unlink("f1");
     d6d:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     d74:	e8 ef 2e 00 00       	call   3c68 <unlink>
  unlink("f2");
     d79:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d93:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     d9a:	00 
     d9b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     da2:	e8 12 30 00 00       	call   3db9 <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     db2:	b8 90 46 00 00       	mov    $0x4690,%eax
     db7:	eb 05                	jmp    dbe <twofiles+0x6b>
     db9:	b8 93 46 00 00       	mov    $0x4693,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     ddd:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
     de4:	00 
     de5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dec:	e8 c8 2f 00 00       	call   3db9 <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
     ...
     e14:	c7 04 24 60 86 00 00 	movl   $0x8660,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e30:	00 
     e31:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     e38:	00 
     ...
     e57:	c7 44 24 04 a5 46 00 	movl   $0x46a5,0x4(%esp)
     e5e:	00 
     e5f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e66:	e8 4e 2f 00 00       	call   3db9 <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea7:	b8 90 46 00 00       	mov    $0x4690,%eax
     eac:	eb 05                	jmp    eb3 <twofiles+0x160>
     eae:	b8 93 46 00 00       	mov    $0x4693,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     edb:	05 60 86 00 00       	add    $0x8660,%eax
     ...
     efa:	74 19                	je     f15 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     efc:	c7 44 24 04 b6 46 00 	movl   $0x46b6,0x4(%esp)
     f03:	00 
     f04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f0b:	e8 a9 2e 00 00       	call   3db9 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f2e:	00 
     f2f:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
     f36:	00 
    ...
    if(total != 12*500){
     ...
     f66:	c7 44 24 04 c2 46 00 	movl   $0x46c2,0x4(%esp)
     f6d:	00 
     f6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f75:	e8 3f 2e 00 00       	call   3db9 <printf>
      exit();
  ...
  unlink("f1");
     f8d:	c7 04 24 90 46 00 00 	movl   $0x4690,(%esp)
     f94:	e8 cf 2c 00 00       	call   3c68 <unlink>
  unlink("f2");
     f99:	c7 04 24 93 46 00 00 	movl   $0x4693,(%esp)
     fa0:	e8 c3 2c 00 00       	call   3c68 <unlink>

  printf(1, "twofiles ok\n");
     fa5:	c7 44 24 04 d3 46 00 	movl   $0x46d3,0x4(%esp)
     fac:	00 
     fad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fb4:	e8 00 2e 00 00       	call   3db9 <printf>
}
     fb9:	c9                   	leave  
     fba:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fc1:	c7 44 24 04 e0 46 00 	movl   $0x46e0,0x4(%esp)
     fc8:	00 
     fc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fd0:	e8 e4 2d 00 00       	call   3db9 <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fe3:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
     fea:	00 
     feb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ff2:	e8 c2 2d 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1044:	79 19                	jns    105f <createdelete+0xa4>
      printf(1, "create failed\n");
    1046:	c7 44 24 04 96 46 00 	movl   $0x4696,0x4(%esp)
    104d:	00 
    104e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1055:	e8 5f 2d 00 00       	call   3db9 <printf>
      exit();
    ...
    109b:	c7 44 24 04 f3 46 00 	movl   $0x46f3,0x4(%esp)
    10a2:	00 
    10a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10aa:	e8 0a 2d 00 00       	call   3db9 <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    111a:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    1121:	00 
    1122:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1129:	e8 8b 2c 00 00       	call   3db9 <printf>
      exit();
    ...
    114c:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    1153:	00 
    1154:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    115b:	e8 59 2c 00 00       	call   3db9 <printf>
      exit();
    ...
    11b2:	c7 44 24 04 04 47 00 	movl   $0x4704,0x4(%esp)
    11b9:	00 
    11ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11c1:	e8 f3 2b 00 00       	call   3db9 <printf>
      exit();
    ...
    11e4:	c7 44 24 04 28 47 00 	movl   $0x4728,0x4(%esp)
    11eb:	00 
    11ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11f3:	e8 c1 2b 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1256:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
    125d:	00 
    125e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1265:	e8 4f 2b 00 00       	call   3db9 <printf>
}
    126a:	c9                   	leave  
    126b:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1272:	c7 44 24 04 59 47 00 	movl   $0x4759,0x4(%esp)
    1279:	00 
    127a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1281:	e8 33 2b 00 00       	call   3db9 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1286:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    128d:	00 
    128e:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(fd < 0){
    ...
    12a3:	c7 44 24 04 75 47 00 	movl   $0x4775,0x4(%esp)
    12aa:	00 
    12ab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12b2:	e8 02 2b 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12c3:	00 
    12c4:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    12cb:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e9:	00 
    12ea:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1385:	00 
    1386:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    138d:	00 
    ...
    139e:	c7 44 24 04 cb 47 00 	movl   $0x47cb,0x4(%esp)
    13a5:	00 
    13a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13ad:	e8 07 2a 00 00       	call   3db9 <printf>
    exit();
    13b2:	e8 61 28 00 00       	call   3c18 <exit>
  }
  if(buf[0] != 'h'){
    13b7:	0f b6 05 60 86 00 00 	movzbl 0x8660,%eax
    13be:	3c 68                	cmp    $0x68,%al
    13c0:	74 19                	je     13db <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    13c2:	c7 44 24 04 e2 47 00 	movl   $0x47e2,0x4(%esp)
    13c9:	00 
    13ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13d1:	e8 e3 29 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13e2:	00 
    13e3:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    13ea:	00 
    ...
    13fb:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
    1402:	00 
    1403:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    140a:	e8 aa 29 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("unlinkread");
    141f:	c7 04 24 6a 47 00 00 	movl   $0x476a,(%esp)
    1426:	e8 3d 28 00 00       	call   3c68 <unlink>
  printf(1, "unlinkread ok\n");
    142b:	c7 44 24 04 12 48 00 	movl   $0x4812,0x4(%esp)
    1432:	00 
    1433:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    143a:	e8 7a 29 00 00       	call   3db9 <printf>
}
    143f:	c9                   	leave  
    1440:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1447:	c7 44 24 04 21 48 00 	movl   $0x4821,0x4(%esp)
    144e:	00 
    144f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1456:	e8 5e 29 00 00       	call   3db9 <printf>

  unlink("lf1");
    145b:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
    1462:	e8 01 28 00 00       	call   3c68 <unlink>
  unlink("lf2");
    1467:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    146e:	e8 f5 27 00 00       	call   3c68 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1473:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    147a:	00 
    147b:	c7 04 24 2b 48 00 00 	movl   $0x482b,(%esp)
  ...
  if(fd < 0){
    ...
    1490:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
    1497:	00 
    1498:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149f:	e8 15 29 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14b0:	00 
    14b1:	c7 44 24 04 8f 47 00 	movl   $0x478f,0x4(%esp)
    14b8:	00 
    ...
    14c9:	c7 44 24 04 46 48 00 	movl   $0x4846,0x4(%esp)
    14d0:	00 
    14d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d8:	e8 dc 28 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1562:	00 
    1563:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
  ...
  if(fd < 0){
    ...
    1578:	c7 44 24 04 95 48 00 	movl   $0x4895,0x4(%esp)
    157f:	00 
    1580:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1587:	e8 2d 28 00 00       	call   3db9 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1598:	00 
    1599:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    15a0:	00 
    ...
    15b1:	c7 44 24 04 a6 48 00 	movl   $0x48a6,0x4(%esp)
    15b8:	00 
    15b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15c0:	e8 f4 27 00 00       	call   3db9 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d5:	c7 44 24 04 2f 48 00 	movl   $0x482f,0x4(%esp)
    15dc:	00 
    15dd:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    15e4:	e8 8f 26 00 00       	call   3c78 <link>
    15e9:	85 c0                	test   %eax,%eax
    15eb:	78 19                	js     1606 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15ed:	c7 44 24 04 b7 48 00 	movl   $0x48b7,0x4(%esp)
    15f4:	00 
    15f5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15fc:	e8 b8 27 00 00       	call   3db9 <printf>
    exit();
    1601:	e8 12 26 00 00       	call   3c18 <exit>
  }

  unlink("lf2");
    1606:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    160d:	e8 56 26 00 00       	call   3c68 <unlink>
  if(link("lf2", "lf1") >= 0){
    1612:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    1619:	00 
    161a:	c7 04 24 2f 48 00 00 	movl   $0x482f,(%esp)
    1621:	e8 52 26 00 00       	call   3c78 <link>
    1626:	85 c0                	test   %eax,%eax
    1628:	78 19                	js     1643 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    162a:	c7 44 24 04 d8 48 00 	movl   $0x48d8,0x4(%esp)
    1631:	00 
    1632:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1639:	e8 7b 27 00 00       	call   3db9 <printf>
    exit();
    163e:	e8 d5 25 00 00       	call   3c18 <exit>
  }

  if(link(".", "lf1") >= 0){
    1643:	c7 44 24 04 2b 48 00 	movl   $0x482b,0x4(%esp)
    164a:	00 
    164b:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
    1652:	e8 21 26 00 00       	call   3c78 <link>
    1657:	85 c0                	test   %eax,%eax
    1659:	78 19                	js     1674 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    165b:	c7 44 24 04 fd 48 00 	movl   $0x48fd,0x4(%esp)
    1662:	00 
    1663:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    166a:	e8 4a 27 00 00       	call   3db9 <printf>
    exit();
    166f:	e8 a4 25 00 00       	call   3c18 <exit>
  }

  printf(1, "linktest ok\n");
    1674:	c7 44 24 04 19 49 00 	movl   $0x4919,0x4(%esp)
    167b:	00 
    167c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1683:	e8 31 27 00 00       	call   3db9 <printf>
}
    1688:	c9                   	leave  
    1689:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1690:	c7 44 24 04 26 49 00 	movl   $0x4926,0x4(%esp)
    1697:	00 
    1698:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169f:	e8 15 27 00 00       	call   3db9 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1703:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1746:	c7 04 24 36 49 00 00 	movl   $0x4936,(%esp)
    ...
    1777:	c7 44 24 04 39 49 00 	movl   $0x4939,0x4(%esp)
    177e:	00 
    177f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1786:	e8 2e 26 00 00       	call   3db9 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17db:	00 
    17dc:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    183e:	c7 44 24 04 55 49 00 	movl   $0x4955,0x4(%esp)
    1845:	00 
    1846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184d:	e8 67 25 00 00       	call   3db9 <printf>
        exit();
    ...
    1870:	c7 44 24 04 6e 49 00 	movl   $0x496e,0x4(%esp)
    1877:	00 
    1878:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    187f:	e8 35 25 00 00       	call   3db9 <printf>
        exit();
  ...
  if(n != 40){
    ...
    18cb:	c7 44 24 04 8c 49 00 	movl   $0x498c,0x4(%esp)
    18d2:	00 
    18d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18da:	e8 da 24 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1905:	79 19                	jns    1920 <concreate+0x296>
      printf(1, "fork failed\n");
    1907:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    190e:	00 
    190f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1916:	e8 9e 24 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a27:	c7 44 24 04 bd 49 00 	movl   $0x49bd,0x4(%esp)
    1a2e:	00 
    1a2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a36:	e8 7e 23 00 00       	call   3db9 <printf>
}
    1a3b:	c9                   	leave  
    1a3c:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a43:	c7 44 24 04 cb 49 00 	movl   $0x49cb,0x4(%esp)
    1a4a:	00 
    1a4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a52:	e8 62 23 00 00       	call   3db9 <printf>

  unlink("x");
    1a57:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a71:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    1a78:	00 
    1a79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a80:	e8 34 23 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1adf:	00 
    1ae0:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
    ...
    1b11:	75 16                	jne    1b29 <linkunlink+0xec>
      link("cat", "x");
    1b13:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    1b1a:	00 
    1b1b:	c7 04 24 dc 49 00 00 	movl   $0x49dc,(%esp)
    1b22:	e8 51 21 00 00       	call   3c78 <link>
    1b27:	eb 0c                	jmp    1b35 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b29:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b55:	c7 44 24 04 e0 49 00 	movl   $0x49e0,0x4(%esp)
    1b5c:	00 
    1b5d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b64:	e8 50 22 00 00       	call   3db9 <printf>
}
    1b69:	c9                   	leave  
    1b6a:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b71:	c7 44 24 04 ef 49 00 	movl   $0x49ef,0x4(%esp)
    1b78:	00 
    1b79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b80:	e8 34 22 00 00       	call   3db9 <printf>
  unlink("bd");
    1b85:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
    1b8c:	e8 d7 20 00 00       	call   3c68 <unlink>

  fd = open("bd", O_CREATE);
    1b91:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b98:	00 
    1b99:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  if(fd < 0){
    ...
    1bae:	c7 44 24 04 ff 49 00 	movl   $0x49ff,0x4(%esp)
    1bb5:	00 
    1bb6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bbd:	e8 f7 21 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("bd");
    1c48:	c7 04 24 fc 49 00 00 	movl   $0x49fc,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9c:	c7 44 24 04 29 4a 00 	movl   $0x4a29,0x4(%esp)
    1ca3:	00 
    1ca4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cab:	e8 09 21 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc2:	c7 44 24 04 3e 4a 00 	movl   $0x4a3e,0x4(%esp)
    1cc9:	00 
    1cca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd1:	e8 e3 20 00 00       	call   3db9 <printf>
}
    1cd6:	c9                   	leave  
    1cd7:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cde:	c7 44 24 04 49 4a 00 	movl   $0x4a49,0x4(%esp)
    1ce5:	00 
    1ce6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ced:	e8 c7 20 00 00       	call   3db9 <printf>

  unlink("ff");
    1cf2:	c7 04 24 56 4a 00 00 	movl   $0x4a56,(%esp)
    1cf9:	e8 6a 1f 00 00       	call   3c68 <unlink>
  if(mkdir("dd") != 0){
    1cfe:	c7 04 24 59 4a 00 00 	movl   $0x4a59,(%esp)
    1d05:	e8 76 1f 00 00       	call   3c80 <mkdir>
    1d0a:	85 c0                	test   %eax,%eax
    1d0c:	74 19                	je     1d27 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0e:	c7 44 24 04 5c 4a 00 	movl   $0x4a5c,0x4(%esp)
    1d15:	00 
    1d16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1d:	e8 97 20 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2e:	00 
    1d2f:	c7 04 24 74 4a 00 00 	movl   $0x4a74,(%esp)
  ...
  if(fd < 0){
    ...
    1d44:	c7 44 24 04 7a 4a 00 	movl   $0x4a7a,0x4(%esp)
    1d4b:	00 
    1d4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d53:	e8 61 20 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d64:	00 
    1d65:	c7 44 24 04 56 4a 00 	movl   $0x4a56,0x4(%esp)
    1d6c:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddc:	00 
    1ddd:	c7 04 24 d8 4a 00 00 	movl   $0x4ad8,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 e1 4a 00 	movl   $0x4ae1,0x4(%esp)
    1df9:	00 
    1dfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e01:	e8 b3 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e12:	00 
    1e13:	c7 44 24 04 f9 4a 00 	movl   $0x4af9,0x4(%esp)
    1e1a:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e38:	00 
    1e39:	c7 04 24 fc 4a 00 00 	movl   $0x4afc,(%esp)
  ...
  if(fd < 0){
    ...
    1e4e:	c7 44 24 04 08 4b 00 	movl   $0x4b08,0x4(%esp)
    1e55:	00 
    1e56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5d:	e8 57 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e6e:	00 
    1e6f:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    1e76:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8b:	0f b6 05 60 86 00 00 	movzbl 0x8660,%eax
    1e92:	3c 66                	cmp    $0x66,%al
    1e94:	74 19                	je     1eaf <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    1e96:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    1e9d:	00 
    1e9e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea5:	e8 0f 1f 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ff0:	00 
    1ff1:	c7 04 24 3c 4b 00 00 	movl   $0x4b3c,(%esp)
  ...
  if(fd < 0){
    ...
    2006:	c7 44 24 04 06 4c 00 	movl   $0x4c06,0x4(%esp)
    200d:	00 
    200e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2015:	e8 9f 1d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2026:	00 
    2027:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    202e:	00 
    ...
    203f:	c7 44 24 04 1e 4c 00 	movl   $0x4c1e,0x4(%esp)
    2046:	00 
    2047:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204e:	e8 66 1d 00 00       	call   3db9 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2424:	c7 44 24 04 98 4e 00 	movl   $0x4e98,0x4(%esp)
    242b:	00 
    242c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2433:	e8 81 19 00 00       	call   3db9 <printf>

  unlink("bigwrite");
    2438:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2457:	00 
    2458:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
    ...
    246d:	c7 44 24 04 b0 4e 00 	movl   $0x4eb0,0x4(%esp)
    2474:	00 
    2475:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247c:	e8 38 19 00 00       	call   3db9 <printf>
      exit();
    ...
    2496:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    249d:	00 
    ...
    24c2:	c7 44 24 04 c8 4e 00 	movl   $0x4ec8,0x4(%esp)
    24c9:	00 
    24ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d1:	e8 e3 18 00 00       	call   3db9 <printf>
        exit();
    ...
    unlink("bigwrite");
    24f0:	c7 04 24 a7 4e 00 00 	movl   $0x4ea7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2510:	c7 44 24 04 da 4e 00 	movl   $0x4eda,0x4(%esp)
    2517:	00 
    2518:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251f:	e8 95 18 00 00       	call   3db9 <printf>
}
    2524:	c9                   	leave  
    2525:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252c:	c7 44 24 04 e7 4e 00 	movl   $0x4ee7,0x4(%esp)
    2533:	00 
    2534:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253b:	e8 79 18 00 00       	call   3db9 <printf>

  unlink("bigfile");
    2540:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    2547:	e8 1c 17 00 00       	call   3c68 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2553:	00 
    2554:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2569:	c7 44 24 04 fd 4e 00 	movl   $0x4efd,0x4(%esp)
    2570:	00 
    2571:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2578:	e8 3c 18 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    259a:	c7 04 24 60 86 00 00 	movl   $0x8660,(%esp)
    25a1:	e8 c5 14 00 00       	call   3a6b <memset>
    if(write(fd, buf, 600) != 600){
    25a6:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    25ad:	00 
    25ae:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    25b5:	00 
    ...
    25c8:	c7 44 24 04 13 4f 00 	movl   $0x4f13,0x4(%esp)
    25cf:	00 
    25d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d7:	e8 dd 17 00 00       	call   3db9 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fd:	00 
    25fe:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
  ...
  if(fd < 0){
    ...
    2613:	c7 44 24 04 29 4f 00 	movl   $0x4f29,0x4(%esp)
    261a:	00 
    261b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2622:	e8 92 17 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    2641:	00 
    2642:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    2649:	00 
    ...
    265e:	c7 44 24 04 3e 4f 00 	movl   $0x4f3e,0x4(%esp)
    2665:	00 
    2666:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266d:	e8 47 17 00 00       	call   3db9 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    26a1:	c7 44 24 04 53 4f 00 	movl   $0x4f53,0x4(%esp)
    26a8:	00 
    26a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26b0:	e8 04 17 00 00       	call   3db9 <printf>
      exit();
    26b5:	e8 5e 15 00 00       	call   3c18 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    26ba:	0f b6 05 60 86 00 00 	movzbl 0x8660,%eax
    ...
    26d4:	0f b6 05 8b 87 00 00 	movzbl 0x878b,%eax
    ...
    26ec:	74 19                	je     2707 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    26ee:	c7 44 24 04 67 4f 00 	movl   $0x4f67,0x4(%esp)
    26f5:	00 
    26f6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26fd:	e8 b7 16 00 00       	call   3db9 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    2716:	c7 44 24 04 80 4f 00 	movl   $0x4f80,0x4(%esp)
    271d:	00 
    271e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2725:	e8 8f 16 00 00       	call   3db9 <printf>
    exit();
    272a:	e8 e9 14 00 00       	call   3c18 <exit>
  }
  unlink("bigfile");
    272f:	c7 04 24 f5 4e 00 00 	movl   $0x4ef5,(%esp)
    2736:	e8 2d 15 00 00       	call   3c68 <unlink>

  printf(1, "bigfile test ok\n");
    273b:	c7 44 24 04 9a 4f 00 	movl   $0x4f9a,0x4(%esp)
    2742:	00 
    2743:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    274a:	e8 6a 16 00 00       	call   3db9 <printf>
}
    274f:	c9                   	leave  
    2750:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27c4:	00 
    27c5:	c7 04 24 38 50 00 00 	movl   $0x5038,(%esp)
  ...
  if(fd < 0){
    ...
    27da:	c7 44 24 04 68 50 00 	movl   $0x5068,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e9:	e8 cb 15 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2805:	00 
    2806:	c7 04 24 a8 50 00 00 	movl   $0x50a8,(%esp)
  ...
  if(fd < 0){
    ...
    281b:	c7 44 24 04 d8 50 00 	movl   $0x50d8,0x4(%esp)
    2822:	00 
    2823:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    282a:	e8 8a 15 00 00       	call   3db9 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a25:	c7 44 24 04 81 52 00 	movl   $0x5281,0x4(%esp)
    2a2c:	00 
    2a2d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a34:	e8 80 13 00 00       	call   3db9 <printf>

  fd = open("dirfile", O_CREATE);
    2a39:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a40:	00 
    2a41:	c7 04 24 8e 52 00 00 	movl   $0x528e,(%esp)
  ...
  if(fd < 0){
    ...
    2a56:	c7 44 24 04 96 52 00 	movl   $0x5296,0x4(%esp)
    2a5d:	00 
    2a5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a65:	e8 4f 13 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aaa:	00 
    2aab:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  if(fd >= 0){
    ...
    2ac0:	c7 44 24 04 d2 52 00 	movl   $0x52d2,0x4(%esp)
    2ac7:	00 
    2ac8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2acf:	e8 e5 12 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ae0:	00 
    2ae1:	c7 04 24 c7 52 00 00 	movl   $0x52c7,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bc2:	00 
    2bc3:	c7 04 24 fb 48 00 00 	movl   $0x48fb,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd8:	c7 44 24 04 6c 53 00 	movl   $0x536c,0x4(%esp)
    2bdf:	00 
    2be0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be7:	e8 cd 11 00 00       	call   3db9 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c27:	c7 44 24 04 8b 53 00 	movl   $0x538b,0x4(%esp)
    2c2e:	00 
    2c2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c36:	e8 7e 11 00 00       	call   3db9 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c4b:	c7 44 24 04 9f 53 00 	movl   $0x539f,0x4(%esp)
    2c52:	00 
    2c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c5a:	e8 5a 11 00 00       	call   3db9 <printf>
}
    2c5f:	c9                   	leave  
    2c60:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c67:	c7 44 24 04 af 53 00 	movl   $0x53af,0x4(%esp)
    2c6e:	00 
    2c6f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c76:	e8 3e 11 00 00       	call   3db9 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d28:	00 
    2d29:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
    ...
    unlink("xx");
    2d49:	c7 04 24 ef 53 00 00 	movl   $0x53ef,(%esp)
  ...
  chdir("/");
    2d63:	c7 04 24 12 52 00 00 	movl   $0x5212,(%esp)
    2d6a:	e8 19 0f 00 00       	call   3c88 <chdir>
  printf(1, "empty file name OK\n");
    2d6f:	c7 44 24 04 f2 53 00 	movl   $0x53f2,0x4(%esp)
    2d76:	00 
    2d77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d7e:	e8 36 10 00 00       	call   3db9 <printf>
}
    2d83:	c9                   	leave  
    2d84:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d8b:	c7 44 24 04 06 54 00 	movl   $0x5406,0x4(%esp)
    2d92:	00 
    2d93:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d9a:	e8 1a 10 00 00       	call   3db9 <printf>
    ...
    2dbe:	e8 55 0e 00 00       	call   3c18 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd9:	c7 44 24 04 14 54 00 	movl   $0x5414,0x4(%esp)
    2de0:	00 
    2de1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de8:	e8 cc 0f 00 00       	call   3db9 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2dfd:	c7 44 24 04 36 54 00 	movl   $0x5436,0x4(%esp)
    2e04:	00 
    2e05:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e0c:	e8 a8 0f 00 00       	call   3db9 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e2a:	c7 44 24 04 4a 54 00 	movl   $0x544a,0x4(%esp)
    2e31:	00 
    2e32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e39:	e8 7b 0f 00 00       	call   3db9 <printf>
    exit();
    2e3e:	e8 d5 0d 00 00       	call   3c18 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e43:	c7 44 24 04 5d 54 00 	movl   $0x545d,0x4(%esp)
    2e4a:	00 
    2e4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e52:	e8 62 0f 00 00       	call   3db9 <printf>
}
    2e57:	c9                   	leave  
    2e58:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e63:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    2e68:	c7 44 24 04 6b 54 00 	movl   $0x546b,0x4(%esp)
    2e6f:	00 
    2e70:	89 04 24             	mov    %eax,(%esp)
    2e73:	e8 41 0f 00 00       	call   3db9 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eb6:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    ...
    2ed0:	c7 44 24 04 76 54 00 	movl   $0x5476,0x4(%esp)
    2ed7:	00 
    2ed8:	89 04 24             	mov    %eax,(%esp)
    2edb:	e8 d9 0e 00 00       	call   3db9 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f0f:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    2f14:	c7 44 24 04 91 54 00 	movl   $0x5491,0x4(%esp)
    2f1b:	00 
    2f1c:	89 04 24             	mov    %eax,(%esp)
    2f1f:	e8 95 0e 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f52:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    2f57:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    2f5e:	00 
    2f5f:	89 04 24             	mov    %eax,(%esp)
    2f62:	e8 52 0e 00 00       	call   3db9 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2fb0:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    2fb5:	c7 44 24 04 c4 54 00 	movl   $0x54c4,0x4(%esp)
    2fbc:	00 
    2fbd:	89 04 24             	mov    %eax,(%esp)
    2fc0:	e8 f4 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ffb:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3000:	c7 44 24 04 02 55 00 	movl   $0x5502,0x4(%esp)
    3007:	00 
    3008:	89 04 24             	mov    %eax,(%esp)
    300b:	e8 a9 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    3031:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    ...
    3044:	c7 44 24 04 20 55 00 	movl   $0x5520,0x4(%esp)
    304b:	00 
    304c:	89 04 24             	mov    %eax,(%esp)
    304f:	e8 65 0d 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3098:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    ...
    30ab:	c7 44 24 04 58 55 00 	movl   $0x5558,0x4(%esp)
    30b2:	00 
    30b3:	89 04 24             	mov    %eax,(%esp)
    30b6:	e8 fe 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30ca:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    30cf:	c7 44 24 04 80 55 00 	movl   $0x5580,0x4(%esp)
    30d6:	00 
    30d7:	89 04 24             	mov    %eax,(%esp)
    30da:	e8 da 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  if(c != a){
    ...
    3119:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    ...
    312c:	c7 44 24 04 b0 55 00 	movl   $0x55b0,0x4(%esp)
    3133:	00 
    3134:	89 04 24             	mov    %eax,(%esp)
    3137:	e8 7d 0c 00 00       	call   3db9 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    3160:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3165:	c7 44 24 04 79 45 00 	movl   $0x4579,0x4(%esp)
    316c:	00 
    316d:	89 04 24             	mov    %eax,(%esp)
    3170:	e8 44 0c 00 00       	call   3db9 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31e1:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
    31e8:	00 
    31e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31f0:	e8 c4 0b 00 00       	call   3db9 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3244:	00 
    3245:	c7 44 24 04 32 45 00 	movl   $0x4532,0x4(%esp)
    324c:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e5:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    32ea:	c7 44 24 04 ea 55 00 	movl   $0x55ea,0x4(%esp)
    32f1:	00 
    32f2:	89 04 24             	mov    %eax,(%esp)
    32f5:	e8 bf 0a 00 00       	call   3db9 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332b:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3330:	c7 44 24 04 05 56 00 	movl   $0x5605,0x4(%esp)
    3337:	00 
    3338:	89 04 24             	mov    %eax,(%esp)
    333b:	e8 79 0a 00 00       	call   3db9 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3371:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3376:	c7 44 24 04 13 56 00 	movl   $0x5613,0x4(%esp)
    337d:	00 
    337e:	89 04 24             	mov    %eax,(%esp)
    3381:	e8 33 0a 00 00       	call   3db9 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e3:	c7 04 24 22 56 00 00 	movl   $0x5622,(%esp)
    33ea:	e8 89 08 00 00       	call   3c78 <link>
    33ef:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f2:	74 1a                	je     340e <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f4:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    33f9:	c7 44 24 04 2d 56 00 	movl   $0x562d,0x4(%esp)
    3400:	00 
    3401:	89 04 24             	mov    %eax,(%esp)
    3404:	e8 b0 09 00 00       	call   3db9 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    3421:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3426:	c7 44 24 04 46 56 00 	movl   $0x5646,0x4(%esp)
    342d:	00 
    342e:	89 04 24             	mov    %eax,(%esp)
    3431:	e8 83 09 00 00       	call   3db9 <printf>
}
    3436:	c9                   	leave  
    3437:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343e:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3443:	c7 44 24 04 53 56 00 	movl   $0x5653,0x4(%esp)
    344a:	00 
    344b:	89 04 24             	mov    %eax,(%esp)
    344e:	e8 66 09 00 00       	call   3db9 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    3453:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    345a:	eb 2d                	jmp    3489 <bsstest+0x51>
    if(uninit[i] != '\0'){
    345c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    345f:	05 40 5f 00 00       	add    $0x5f40,%eax
    3464:	0f b6 00             	movzbl (%eax),%eax
    3467:	84 c0                	test   %al,%al
    3469:	74 1a                	je     3485 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    346b:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3470:	c7 44 24 04 5d 56 00 	movl   $0x565d,0x4(%esp)
    3477:	00 
    3478:	89 04 24             	mov    %eax,(%esp)
    347b:	e8 39 09 00 00       	call   3db9 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3493:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3498:	c7 44 24 04 6e 56 00 	movl   $0x566e,0x4(%esp)
    349f:	00 
    34a0:	89 04 24             	mov    %eax,(%esp)
    34a3:	e8 11 09 00 00       	call   3db9 <printf>
}
    34a8:	c9                   	leave  
    34a9:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34b0:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(pid == 0){
    ...
    34da:	c7 04 85 a0 5e 00 00 	movl   $0x5688,0x5ea0(,%eax,4)
    34e1:	88 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34ed:	7e e8                	jle    34d7 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    34ef:	c7 05 1c 5f 00 00 00 	movl   $0x0,0x5f1c
    34f6:	00 00 00 
    printf(stdout, "bigarg test\n");
    34f9:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    34fe:	c7 44 24 04 65 57 00 	movl   $0x5765,0x4(%esp)
    3505:	00 
    3506:	89 04 24             	mov    %eax,(%esp)
    3509:	e8 ab 08 00 00       	call   3db9 <printf>
    exec("echo", args);
    350e:	c7 44 24 04 a0 5e 00 	movl   $0x5ea0,0x4(%esp)
    3515:	00 
    3516:	c7 04 24 8c 41 00 00 	movl   $0x418c,(%esp)
    351d:	e8 2e 07 00 00       	call   3c50 <exec>
    printf(stdout, "bigarg test ok\n");
    3522:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3527:	c7 44 24 04 72 57 00 	movl   $0x5772,0x4(%esp)
    352e:	00 
    352f:	89 04 24             	mov    %eax,(%esp)
    3532:	e8 82 08 00 00       	call   3db9 <printf>
    fd = open("bigarg-ok", O_CREATE);
    3537:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    353e:	00 
    353f:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
    ...
    3564:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    3569:	c7 44 24 04 82 57 00 	movl   $0x5782,0x4(%esp)
    3570:	00 
    3571:	89 04 24             	mov    %eax,(%esp)
    3574:	e8 40 08 00 00       	call   3db9 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    358a:	00 
    358b:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
  ...
  if(fd < 0){
    ...
    35a0:	a1 7c 5e 00 00       	mov    0x5e7c,%eax
    35a5:	c7 44 24 04 9b 57 00 	movl   $0x579b,0x4(%esp)
    35ac:	00 
    35ad:	89 04 24             	mov    %eax,(%esp)
    35b0:	e8 04 08 00 00       	call   3db9 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35c5:	c7 04 24 7b 56 00 00 	movl   $0x567b,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35e1:	c7 44 24 04 b0 57 00 	movl   $0x57b0,0x4(%esp)
    35e8:	00 
    35e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35f0:	e8 c4 07 00 00       	call   3db9 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36cb:	c7 44 24 04 bd 57 00 	movl   $0x57bd,0x4(%esp)
    36d2:	00 
    36d3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36da:	e8 da 06 00 00       	call   3db9 <printf>
    ...
    3702:	c7 44 24 04 c9 57 00 	movl   $0x57c9,0x4(%esp)
    3709:	00 
    370a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3711:	e8 a3 06 00 00       	call   3db9 <printf>
      break;
    ...
    3726:	00 
    3727:	c7 44 24 04 60 86 00 	movl   $0x8660,0x4(%esp)
    372e:	00 
    ...
    374e:	c7 44 24 04 d9 57 00 	movl   $0x57d9,0x4(%esp)
    3755:	00 
    3756:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    375d:	e8 57 06 00 00       	call   3db9 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3872:	c7 44 24 04 e9 57 00 	movl   $0x57e9,0x4(%esp)
    3879:	00 
    387a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3881:	e8 33 05 00 00       	call   3db9 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    388f:	a1 80 5e 00 00       	mov    0x5e80,%eax
    3894:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    389a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    389f:	a3 80 5e 00 00       	mov    %eax,0x5e80
  return randstate;
    38a4:	a1 80 5e 00 00       	mov    0x5e80,%eax
}
    38a9:	5d                   	pop    %ebp
    38aa:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3900:	00 
    3901:	c7 04 24 13 58 00 00 	movl   $0x5813,(%esp)
...
00003cb8 <exit_status>:
    3cb8:	b8 16 00 00 00       	mov    $0x16,%eax
    3cbd:	cd 40                	int    $0x40
    3cbf:	c3                   	ret    

00003cc0 <wait_status>:
...
00003cd0 <change_priority>:
    3cd0:	b8 19 00 00 00       	mov    $0x19,%eax
    3cd5:	cd 40                	int    $0x40
    3cd7:	c3                   	ret    

00003cd8 <set_priority>:
...
00003d08 <printint>:
    ...
    3d0b:	53                   	push   %ebx
    3d0c:	83 ec 44             	sub    $0x44,%esp
    3d0f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3d16:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d1a:	74 17                	je     3d33 <printint+0x2b>
    3d1c:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d20:	79 11                	jns    3d33 <printint+0x2b>
    3d22:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    3d29:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d2c:	f7 d8                	neg    %eax
    3d2e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d31:	eb 06                	jmp    3d39 <printint+0x31>
    3d33:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d36:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d39:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    3d40:	8b 4d ec             	mov    -0x14(%ebp),%ecx
    3d43:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3d46:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d49:	ba 00 00 00 00       	mov    $0x0,%edx
    3d4e:	f7 f3                	div    %ebx
    3d50:	89 d0                	mov    %edx,%eax
    3d52:	0f b6 80 84 5e 00 00 	movzbl 0x5e84(%eax),%eax
    3d59:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
    3d5d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    3d61:	8b 45 10             	mov    0x10(%ebp),%eax
    3d64:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    3d67:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3d6a:	ba 00 00 00 00       	mov    $0x0,%edx
    3d6f:	f7 75 d4             	divl   -0x2c(%ebp)
    3d72:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3d75:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3d79:	75 c5                	jne    3d40 <printint+0x38>
    3d7b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d7f:	74 28                	je     3da9 <printint+0xa1>
    3d81:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d84:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
    3d89:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    3d8d:	eb 1a                	jmp    3da9 <printint+0xa1>
    3d8f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d92:	0f b6 44 05 dc       	movzbl -0x24(%ebp,%eax,1),%eax
    3d97:	0f be c0             	movsbl %al,%eax
    3d9a:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d9e:	8b 45 08             	mov    0x8(%ebp),%eax
    3da1:	89 04 24             	mov    %eax,(%esp)
    3da4:	e8 37 ff ff ff       	call   3ce0 <putc>
    3da9:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
    3dad:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3db1:	79 dc                	jns    3d8f <printint+0x87>
    3db3:	83 c4 44             	add    $0x44,%esp
    3db6:	5b                   	pop    %ebx
    3db7:	5d                   	pop    %ebp
    3db8:	c3                   	ret    
...
00003db9 <printf>:
    ...
    3dbf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dc6:	8d 45 0c             	lea    0xc(%ebp),%eax
    3dc9:	83 c0 04             	add    $0x4,%eax
    3dcc:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3dcf:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    3dd6:	e9 7e 01 00 00       	jmp    3f59 <printf+0x1a0>
    3ddb:	8b 55 0c             	mov    0xc(%ebp),%edx
    3dde:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3de1:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3de4:	0f b6 00             	movzbl (%eax),%eax
    3de7:	0f be c0             	movsbl %al,%eax
    3dea:	25 ff 00 00 00       	and    $0xff,%eax
    3def:	89 45 e8             	mov    %eax,-0x18(%ebp)
    3df2:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3df6:	75 2c                	jne    3e24 <printf+0x6b>
    3df8:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3dfc:	75 0c                	jne    3e0a <printf+0x51>
    3dfe:	c7 45 f0 25 00 00 00 	movl   $0x25,-0x10(%ebp)
    3e05:	e9 4b 01 00 00       	jmp    3f55 <printf+0x19c>
    3e0a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e0d:	0f be c0             	movsbl %al,%eax
    3e10:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e14:	8b 45 08             	mov    0x8(%ebp),%eax
    3e17:	89 04 24             	mov    %eax,(%esp)
    3e1a:	e8 c1 fe ff ff       	call   3ce0 <putc>
    3e1f:	e9 31 01 00 00       	jmp    3f55 <printf+0x19c>
    3e24:	83 7d f0 25          	cmpl   $0x25,-0x10(%ebp)
    3e28:	0f 85 27 01 00 00    	jne    3f55 <printf+0x19c>
    3e2e:	83 7d e8 64          	cmpl   $0x64,-0x18(%ebp)
    3e32:	75 2d                	jne    3e61 <printf+0xa8>
    3e34:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e37:	8b 00                	mov    (%eax),%eax
    3e39:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e40:	00 
    3e41:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e48:	00 
    3e49:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e4d:	8b 45 08             	mov    0x8(%ebp),%eax
    3e50:	89 04 24             	mov    %eax,(%esp)
    3e53:	e8 b0 fe ff ff       	call   3d08 <printint>
    3e58:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3e5c:	e9 ed 00 00 00       	jmp    3f4e <printf+0x195>
    3e61:	83 7d e8 78          	cmpl   $0x78,-0x18(%ebp)
    3e65:	74 06                	je     3e6d <printf+0xb4>
    3e67:	83 7d e8 70          	cmpl   $0x70,-0x18(%ebp)
    3e6b:	75 2d                	jne    3e9a <printf+0xe1>
    3e6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3e70:	8b 00                	mov    (%eax),%eax
    3e72:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e79:	00 
    3e7a:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e81:	00 
    3e82:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e86:	8b 45 08             	mov    0x8(%ebp),%eax
    3e89:	89 04 24             	mov    %eax,(%esp)
    3e8c:	e8 77 fe ff ff       	call   3d08 <printint>
    3e91:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3e95:	e9 b4 00 00 00       	jmp    3f4e <printf+0x195>
    3e9a:	83 7d e8 73          	cmpl   $0x73,-0x18(%ebp)
    3e9e:	75 46                	jne    3ee6 <printf+0x12d>
    3ea0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ea3:	8b 00                	mov    (%eax),%eax
    3ea5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3ea8:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3eac:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    3eb0:	75 27                	jne    3ed9 <printf+0x120>
    3eb2:	c7 45 e4 4e 58 00 00 	movl   $0x584e,-0x1c(%ebp)
    3eb9:	eb 1f                	jmp    3eda <printf+0x121>
    3ebb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3ebe:	0f b6 00             	movzbl (%eax),%eax
    3ec1:	0f be c0             	movsbl %al,%eax
    3ec4:	89 44 24 04          	mov    %eax,0x4(%esp)
    3ec8:	8b 45 08             	mov    0x8(%ebp),%eax
    3ecb:	89 04 24             	mov    %eax,(%esp)
    3ece:	e8 0d fe ff ff       	call   3ce0 <putc>
    3ed3:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    3ed7:	eb 01                	jmp    3eda <printf+0x121>
    3ed9:	90                   	nop
    3eda:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3edd:	0f b6 00             	movzbl (%eax),%eax
    3ee0:	84 c0                	test   %al,%al
    3ee2:	75 d7                	jne    3ebb <printf+0x102>
    3ee4:	eb 68                	jmp    3f4e <printf+0x195>
    3ee6:	83 7d e8 63          	cmpl   $0x63,-0x18(%ebp)
    3eea:	75 1d                	jne    3f09 <printf+0x150>
    ...
    3efe:	e8 dd fd ff ff       	call   3ce0 <putc>
    3f03:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    3f07:	eb 45                	jmp    3f4e <printf+0x195>
    3f09:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    3f0d:	75 17                	jne    3f26 <printf+0x16d>
    3f0f:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f12:	0f be c0             	movsbl %al,%eax
    3f15:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f19:	8b 45 08             	mov    0x8(%ebp),%eax
    3f1c:	89 04 24             	mov    %eax,(%esp)
    3f1f:	e8 bc fd ff ff       	call   3ce0 <putc>
    3f24:	eb 28                	jmp    3f4e <printf+0x195>
    3f26:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f2d:	00 
    3f2e:	8b 45 08             	mov    0x8(%ebp),%eax
    3f31:	89 04 24             	mov    %eax,(%esp)
    3f34:	e8 a7 fd ff ff       	call   3ce0 <putc>
    3f39:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f3c:	0f be c0             	movsbl %al,%eax
    3f3f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f43:	8b 45 08             	mov    0x8(%ebp),%eax
    3f46:	89 04 24             	mov    %eax,(%esp)
    3f49:	e8 92 fd ff ff       	call   3ce0 <putc>
    3f4e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3f55:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    3f59:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f5c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3f5f:	8d 04 02             	lea    (%edx,%eax,1),%eax
    3f62:	0f b6 00             	movzbl (%eax),%eax
    3f65:	84 c0                	test   %al,%al
    3f67:	0f 85 6e fe ff ff    	jne    3ddb <printf+0x22>
    3f6d:	c9                   	leave  
    3f6e:	c3                   	ret    
    3f6f:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f7f:	a1 28 5f 00 00       	mov    0x5f28,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    404a:	a3 28 5f 00 00       	mov    %eax,0x5f28
}
    404f:	c9                   	leave  
    4050:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4070:	e8 2b fc ff ff       	call   3ca0 <sbrk>
  ...
  return freep;
    40a2:	a1 28 5f 00 00       	mov    0x5f28,%eax
}
    40a7:	c9                   	leave  
    40a8:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40be:	a1 28 5f 00 00       	mov    0x5f28,%eax
    40c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40c6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40ca:	75 23                	jne    40ef <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40cc:	c7 45 f0 20 5f 00 00 	movl   $0x5f20,-0x10(%ebp)
    40d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40d6:	a3 28 5f 00 00       	mov    %eax,0x5f28
    40db:	a1 28 5f 00 00       	mov    0x5f28,%eax
    40e0:	a3 20 5f 00 00       	mov    %eax,0x5f20
    base.s.size = 0;
    40e5:	c7 05 24 5f 00 00 00 	movl   $0x0,0x5f24
    40ec:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    411f:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4122:	89 c2                	mov    %eax,%edx
    ...
    4142:	a3 28 5f 00 00       	mov    %eax,0x5f28
      return (void*)(p + 1);
    ...
    if(p == freep)
    414f:	a1 28 5f 00 00       	mov    0x5f28,%eax
